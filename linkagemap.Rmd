...
For more details about the procedures founded in this paper, also the strategies to build a genetic linkage map using *OneMap R-package*, please check [our youtube video](https://www.youtube.com/watch?v=Uaax9SRUEbE&feature=youtu.be).

See also [ou R-code](https://github.com/biomarkUSP/mimulus/blob/master/linkage_map_codes.R) used in this study, which is freely available to practice the concepts presented here.
__________________________________________________________________________________________
